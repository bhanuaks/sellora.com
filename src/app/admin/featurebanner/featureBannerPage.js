                  ...
                  <hr></hr> 
                    <div className="row">
                      ...
                      <div className="col-lg-4">
                        ...
                        <div style={{color:'red'}}><span>Note: </span> Image size of 350px (width) × 400px (height) </div>
                      </div>
                  ...
                  <hr></hr> 
                    <div className="row">
                      ...
                      <div className="col-lg-4">
                        ...
                        <div style={{color:'red'}}><span>Note: </span>  Image size of 350px (width) × 200px (height) </div>
                      </div>
