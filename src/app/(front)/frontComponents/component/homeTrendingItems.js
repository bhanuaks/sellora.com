...
const HomeTrendingItems = ({ recommendationList }) => {
...
const showWishlist = async (pid, vid) => {
  ...
  return (
    ...
    <>
      ...
      <div
        className="tranding-items-tab-area-start rts-section-gap bg_gradient-tranding-items mt--20"
        bis_skin_checked={1}
      >
...
export default HomeTrendingItems;