...
import PriceFilter from '@/app/(website)/(front)/frontComponents/component/priceFilter';
import CustomerReviewFilter from '@/app/(website)/(front)/frontComponents/component/customerReviewFilter';
import BrandFilter from '@/app/(website)/(front)/frontComponents/component/brandFilter';
import HeaderFilter from '@/app/(website)/(front)/frontComponents/component/headerFilter';
import Product from '@/app/(website)/(front)/frontComponents/Product';
