...
import ProductImageSkeletonLoader from "@/app/(website)/skeleton_loader/product_image";
import ProductDetailsSkeletonLoader from "@/app/(website)/skeleton_loader/productDetails";
import ListingLoaderSkeleton from "@/app/(website)/skeleton_loader/listingLoader";
import { CartContaxt } from "@/app/(website)/contaxtData/cartContaxt";
...
.product-thumb-filter-group .carousel-container .prev {
    top: 0px;  
    left: 0px;
    right: 0px;
    background: none;
...
.product-thumb-filter-group .carousel-container .next {
    bottom: 0px;
    left: 0px;
    right: 0px;
    background: none;
