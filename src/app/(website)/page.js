...
const DealsBanner1 = lazy(() =>
  import("./(front)/frontComponents/DealsBanner1")
);
    ...
    <>
      <div className="container">
        <div className="row">
          ...
          <div className="background-light-gray-color rts-section-gap">
                    ...
                    <div className="col-lg-4 d-lg-block d-none">
                          ...
                          <a href={bannerLeft.url? bannerLeft.url:"#"}>
                            <div className="small_banner_1">
                              {" "}
                              <img src={`${baseUrl}${bannerLeft.photo}`} />{" "}
                            </div>
                  ...
                  {bannerRight.photo && (
                      <div className="col-lg-4 d-lg-block d-none"> 
                        <a href={`${bannerRight.url?bannerRight.url:"#"}`}>
                          <div className="small_banner_1"> <img src={`${baseUrl}${bannerRight.photo}`} /> </div> 
                        </a>
                      </div>
                  )}
        ...
        <div className="container">
          <div className="row g-5">
            <div className="col-lg-6">
              <div
                className="feature-product-area-large-2 bg_image"
                style={{
                  backgroundImage: `url(${baseUrl}${dealBannerLeft.photo})`,
              ...
              >
                <div className="inner-feature-product-content">
                  ...
                  {dealBannerLeft?.title && (
                    <h2 className="title">{dealBannerLeft.title}</h2>
                  )}
                  {dealBannerLeft?.subtitle && <p>{dealBannerLeft.subtitle}</p>}
                  {dealBannerLeft?.url && (
                    <Link
                      href={`${dealBannerLeft.url}`}
            ...
            <div className="col-lg-6">
              <div
                className="feature-product-area-large-2 bg_2 bg_image"
                style={{
                  backgroundImage: `url(${baseUrl}${dealBannerRight.photo})`,
                  backgroundSize: "cover",
                  backgroundPosition: "center center",
                }}
              >
                <div className="inner-feature-product-content">
                  ...
                  {dealBannerRight?.title && (
                    <h2 className="title">{dealBannerRight.title}</h2>
                  )}
      ...
      <Suspense fallback={<div className="row">Loading...</div>}>
        {bestSeller && <BestSellers bestSeller={bestSeller} />}
      </Suspense> 
        <Suspense fallback={<div className="row">Loading...</div>}> 
         <DealsBanner1 />  
      </Suspense>
