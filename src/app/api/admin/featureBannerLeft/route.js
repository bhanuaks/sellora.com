  ...
  try {
    ...
    if(photo && typeof photo  !== "string"){
      ...
      if (!acceptExtensions.includes(imageExtension)) {
        ...
        await uploadImageFun(photo, uploadingPath, imageName, 350)
    ...
    if(photo_r && typeof photo_r  !== "string"){
      ...
      if (!acceptExtensions.includes(imageExtension)) {
        ...
        const uploadingPath = "public/uploads/banner/banner/";
        await uploadImageFun(photo_r, uploadingPath, imageName, 350)
    ...
    if(photo_m1 && typeof photo_m1  !== "string"){
      ...
      if (!acceptExtensions.includes(imageExtension)) {
        ...
        const uploadingPath = "public/uploads/banner/banner/";
        await uploadImageFun(photo_m1, uploadingPath, imageName, 350)
    ...
    if(photo_m2 && typeof photo_m2  !== "string"){
      ...
      if (!acceptExtensions.includes(imageExtension)) {
        ...
        const uploadingPath = "public/uploads/banner/banner/";
        await uploadImageFun(photo_m2, uploadingPath, imageName, 350)
    ...
    if(photo_m3 && typeof photo_m3  !== "string"){
      ...
      if (!acceptExtensions.includes(imageExtension)) {
        ...
        const uploadingPath = "public/uploads/banner/banner/";
        await uploadImageFun(photo_m3, uploadingPath, imageName, 350)
    ...
    if(photo_m4 && typeof photo_m4  !== "string"){
      ...
      if (!acceptExtensions.includes(imageExtension)) {
        ...
        const uploadingPath = "public/uploads/banner/banner/";
        await uploadImageFun(photo_m4, uploadingPath, imageName, 350)
